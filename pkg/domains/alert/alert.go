...
// # Store
//
// A client of Prometheus, AlertManager, and/or Loki Ruler. Store configuration:
//
//	domain: alert
//	metrics: PROMETHEUS_URL
//	alertmanager: ALERTMANAGER_URL
//	lokiRuler: LOKI_RULER_URL
//
// Any combination of `metrics`, `alertmanager`, and `lokiRuler` may be present.
package alert
